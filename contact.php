...
<div class="container mt-4" id="Contact">  <!--Start Contact Us Container-->
      ...
      <div class="row">  <!--Start Contact Us Row-->
        ...
        <div class="col-md-4 stripe text-white text-center">  <!-- Start Contact Us 2nd Column-->
          <h4>student course and assessment Management</h4>
          <p>student course and assessment Management, 
          Near Veltech juction, Thiruvallur, 
          chennai - 600062<br /> 
          Phone: +91 999999999 <br />
          www.student course and assessment Management.com </p>
