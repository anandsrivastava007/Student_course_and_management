...
<html lang="en">
  <head>
    ...
    <title>student course and assessment Management</title>
  </head>
  <body>
     <!-- Start Nagigation -->
    <nav class="navbar navbar-expand-sm navbar-dark pl-5 fixed-top">
      <a href="index.php" class="navbar-brand">student course and assessment Management</a>
      ...
      <div class="collapse navbar-collapse" id="myMenu">
        <ul class="navbar-nav pl-5 custom-nav">
          ...
          <li class="nav-item custom-nav-item"><a href="quizz/subjects/quiz.html" class="nav-link">Quiz and Events</a></li>
          <?php 
              session_start();   
